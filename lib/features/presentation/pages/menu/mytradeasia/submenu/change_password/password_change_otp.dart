                  ...
                  children: [
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          log("DIGIT 1 : ${_digit1Controller.text}");
                          log("DIGIT 1 : ${_digit1Controller.text.isNotEmpty}");
                ...
                child: isVerifying
                    ...
                    : ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          log("OTP ALLOWED : ${_digit1Controller.text.isNotEmpty && _digit2Controller.text.isNotEmpty && _digit3Controller.text.isNotEmpty && _digit4Controller.text.isNotEmpty && _digit5Controller.text.isNotEmpty && _digit6Controller.text.isNotEmpty}");
                          ...
                          if (_digit1Controller.text.isNotEmpty &&
                            ...
                            await _verifyOTP
                                .call(
                                    paramsOne: otpCode, paramsTwo: widget.email)
                                .then((value) {
                              if (value is DataSuccess) {
                                context.go(
                                  "/mytradeasia/change_password",
                                );
                              } else {
                                showDialog(
                                  context: context,
